                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-5">
                        <div class="header-img">
                            <img src="{{ asset('assets/img/watch-header.png') }}" alt="Product Image">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-3">
                        <div class="product-single">
                            <div class="product-img">
                                <img src="{{ asset('assets/img/product-1.png') }}" alt="Product Image">
                            </div>
                            <div class="product-content">
                    ...
                    <div class="col-md-3">
                        <div class="product-single">
                            <div class="product-img">
                                <img src="{{ asset('assets/img/product-2.png') }}" alt="Product Image">
                            </div>
                            <div class="product-content">
                                <h2>Sports Edition</h2>
                                <h3>$199</h3>
                    ...
                    <div class="col-md-3">
                        <div class="product-single">
                            <div class="product-img">
                                <img src="{{ asset('assets/img/product-3.png') }}" alt="Product Image">
                            </div>
                            <div class="product-content">
                                <h2>Sports Edition</h2>
                                <h3>$249</h3>
                    ...
                    <div class="col-md-3">
                        <div class="product-single">
                            <div class="product-img">
                                <img src="{{ asset('assets/img/product-4.png') }}" alt="Product Image">
                            </div>
                            <div class="product-content">
                                <h2>Sports Edition</h2>
                                <h3>$299</h3>
